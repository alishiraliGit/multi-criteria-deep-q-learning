...
# Github Reference: XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
print('Load abx')
abx = pd.read_csv('processed_files/abx.csv',delimiter='|').values
print('Load culture')
culture=pd.read_csv('processed_files/culture.csv',delimiter='|').values
print('Load microbio')
microbio=pd.read_csv('processed_files/microbio.csv',delimiter='|').values
print('Load demog')
demog=pd.read_csv('processed_files/demog.csv',delimiter='|') # read as DataFrame 
print('Load ce010')
ce010=pd.read_csv('processed_files/ce010000.csv',delimiter='|').values
print('Load ce1020')
ce1020=pd.read_csv('processed_files/ce1000020000.csv',delimiter='|').values
print('Load ce2030')
ce2030=pd.read_csv('processed_files/ce2000030000.csv',delimiter='|').values
print('Load ce3040')
ce3040=pd.read_csv('processed_files/ce3000040000.csv',delimiter='|').values
print('Load ce4050')
ce4050=pd.read_csv('processed_files/ce4000050000.csv',delimiter='|').values
print('Load ce5060')
ce5060=pd.read_csv('processed_files/ce5000060000.csv',delimiter='|').values
print('Load ce6070')
ce6070=pd.read_csv('processed_files/ce6000070000.csv',delimiter='|').values
print('Load ce7080')
ce7080=pd.read_csv('processed_files/ce7000080000.csv',delimiter='|').values
print('Load ce8090')
ce8090=pd.read_csv('processed_files/ce8000090000.csv',delimiter='|').values
print('Load ce90100') 
ce90100=pd.read_csv('processed_files/ce90000100000.csv',delimiter='|').values
print('Load labU') 
labU = np.vstack([pd.read_csv('processed_files/labs_ce.csv',delimiter='|').values, pd.read_csv('processed_files/labs_le.csv',delimiter='|').values  ])
print('Load MV')
MV=pd.read_csv('processed_files/mechvent.csv',delimiter='|').values
print('Load inputpreadm')
inputpreadm=pd.read_csv('processed_files/preadm_fluid.csv',delimiter='|').values
print('Load inputMV')
inputMV=pd.read_csv('processed_files/fluid_mv.csv',delimiter='|').values
print('Load inputCV')
inputCV=pd.read_csv('processed_files/fluid_cv.csv',delimiter='|').values
print('Load vasoMV')
vasoMV=pd.read_csv('processed_files/vaso_mv.csv',delimiter='|').values
print('Load vasoCV')
vasoCV=pd.read_csv('processed_files/vaso_cv.csv',delimiter='|').values
print('Load UOpreadm')
UOpreadm=pd.read_csv('processed_files/preadm_uo.csv',delimiter='|').values
print('Load UO') 
UO=pd.read_csv('processed_files/uo.csv',delimiter='|').values
